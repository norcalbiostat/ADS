...
## Deliverables
Complete the tasks by Thursday below to get oriented to the course materials.

* Read over the [syllabus](syllabus_485.html) on your own.

```{r}
read_excel("schedule_485.xlsx", sheet="assignments") %>%
  filter(floor(task_num)==0) %>% select(Assignment, Location) %>%
...
<img src="fig/get allthethings.jpg" width="40%"/>

----

# Thursday: Websites

Using [notes](notes/cn01_Rbased_websites.html) from a half day workshop. 
