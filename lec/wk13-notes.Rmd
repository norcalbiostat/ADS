...
* Learn about how to pull yourself up by your bootstraps
    - Finish the resampling assignment (Sat 4/25)
* Project 
    - Conduct a peer review of one other projects slides
    - Explore the bivariate relationships within your project data. 
    - Revise all old slides, write up bivariate exploration slides. 
...
`r emo::ji("busts_in_silhouette")` Continue to discuss these questions in your group and write the answers in your `resampling-assignment.Rmd`.
