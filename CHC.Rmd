...
- Figure out how best to use the given keyword list for classification  
  - Try naive brute force classification approach using known, labeled keywords from list
