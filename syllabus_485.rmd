...
* **Textbooks** 
    * Introduction to Statistical Learning (ISLR) [[Ebook]](http://www-bcf.usc.edu/~gareth/ISL/) [[Slides & Videos]](http://auapps.american.edu/alberto/www/analytics/ISLRLectures.html), [[Code]](https://emilhvitfeldt.github.io/ISLR-tidymodels-labs/index.html)
...
3. SQL - because you got to learn this at some point. 
...
* **Traditional coursework** We will be working through ISLR to learn and practice predictive modeling using typical problem sets. 
* **Collaborative note taking** Students will collaborate to generate class-wide course notes and materials. 
