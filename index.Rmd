...
### `r format(wk1.date+5*7, "%m-%d-%Y")` Week 6: Examples in Data Science, Statistical Learning

* Examples in Data Science
    - Tuesday you will share your case study/chapter in DDS with the rest of the class. 
    - There are 8 of you, and we only have 75 minutes total for class. So with housekeeping & discussion,
      prepare to only talk for 5-7 minutes on your chosen chapter/case study. If you have more info 
