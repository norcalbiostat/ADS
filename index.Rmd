...
sched %>% select(-order) %>%
  ...
  pack_rows("Week 8", tn$start[8],   tn$end[8],  label_row_css = hlt.col) %>%
...
tasks %>%
  ...
  pack_rows("Week 7", 31,35, label_row_css = wk.col) %>%
  pack_rows("Week 8", 36,38, label_row_css = hlt.col) %>%
  pack_rows("Week 9", 39,42, label_row_css = wk.col) %>%
  pack_rows("Week 10", 43,45, label_row_css = wk.col) %>%
  pack_rows("Week 11", 46,49, label_row_css = wk.col) %>%
  pack_rows("Week 12", 50,52, label_row_css = wk.col) %>%
  pack_rows("Week 13", 53,55, label_row_css = wk.col) %>%
  pack_rows("Week 14", 56,59, label_row_css = wk.col) %>%
  pack_rows("Week 15", 60,62, label_row_css = wk.col) %>%
  pack_rows("Finals", 63,63, label_row_css = wk.col)
```
